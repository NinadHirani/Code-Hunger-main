  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        "dark-layer-1": "var(--dark-layer-1)",
        "dark-layer-2": "var(--dark-layer-2)",
        "dark-label-2": "var(--dark-label-2)",
        "dark-divider-border-2": "var(--dark-divider-border-2)",
        ...
        olive: "var(--olive)",
        "dark-green-s": "var(--dark-green-s)",
        "dark-blue-s": "var(--dark-blue-s)",
      },
      fontFamily: {
        sans: ["var(--font-sans)"],
